...
public class MessageServiceLocator extends org.apache.axis.client.Service implements cn.mldn.MySpring.service.impl.MessageService {
    ...
    private java.lang.String MessageServiceImplPort_address = "http://192.168.1.102:7777/message";
    ...
    public cn.mldn.MySpring.service.IMessageService getMessageServiceImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            cn.mldn.MySpring.service.impl.MessageServiceImplPortBindingStub _stub = new cn.mldn.MySpring.service.impl.MessageServiceImplPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (cn.mldn.MySpring.service.IMessageService.class.isAssignableFrom(serviceEndpointInterface)) {
                cn.mldn.MySpring.service.impl.MessageServiceImplPortBindingStub _stub = new cn.mldn.MySpring.service.impl.MessageServiceImplPortBindingStub(new java.net.URL(MessageServiceImplPort_address), this);
                _stub.setPortName(getMessageServiceImplPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://impl.service.MySpring.mldn.cn/", "messageService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://impl.service.MySpring.mldn.cn/", "MessageServiceImplPort"));
        }
