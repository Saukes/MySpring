...
public class IMessageServiceProxy implements cn.mldn.MySpring.service.IMessageService {
  private String _endpoint = null;
  private cn.mldn.MySpring.service.IMessageService iMessageService = null;
  ...
  private void _initIMessageServiceProxy() {
    try {
      iMessageService = (new cn.mldn.MySpring.service.impl.MessageServiceLocator()).getMessageServiceImplPort();
  ...
  public cn.mldn.MySpring.service.IMessageService getIMessageService() {
    if (iMessageService == null)
      _initIMessageServiceProxy();
